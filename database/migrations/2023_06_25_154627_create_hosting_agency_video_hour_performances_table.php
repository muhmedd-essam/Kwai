...
class CreateHostingAgencyVideoHourPerformancesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hosting_agency_video_hour_pe', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('hosting_agency_video_hour_performances');
    }
}
